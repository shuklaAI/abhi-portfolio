  ...
  return (
    <div className="min-h-screen pt-24 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <div className="flex gap-4">
              ...
              <button className="inline-flex items-center px-6 py-3 bg-card hover:bg-white/10 border border-white/10 rounded-lg text-white transition-colors">
          ...
          <div className="bg-card p-6 rounded-2xl border border-white/5 shadow-xl relative overflow-hidden">
            ...
            <h3 className="text-xl font-bold text-white mb-6 w-full text-left font-heading relative z-10">Technical Proficiency</h3>
        ...
        {/* Experience Timeline */}
        <div className="mt-24">
          <h2 className="text-2xl font-bold text-white mb-12 font-heading text-center">Experience & Education</h2>
              ...
              <div key={exp.id} className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
                ...
                <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] bg-card p-6 rounded-xl border border-white/5 shadow-lg hover:border-primary/30 transition-all duration-300 hover:-translate-y-1">
                  <div className="flex justify-between items-start mb-2 flex-col sm:flex-row">
                    ...
                    <span className="text-xs font-mono text-primary bg-primary/10 px-2 py-1 rounded mt-1 sm:mt-0">{exp.period}</span>
                  </div>
